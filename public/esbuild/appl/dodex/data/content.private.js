var testit = new Function(`return {
		cards: {
			card1: {
				tab: "A",
				front: {
			...
			card31: {
				tab: "N01",
				front: {
					content: '<h1 style="font-size: 14px;"> <svg height="18" width="17" style="font-family: \\'Open Sans\\', sans-serif;"> <text x="3" y="18" fill="#059">O</text><text x="0" y="15" fill="#059">D</text></svg> doDex</h1>' },
				back: {
					content: ""
				}
			},
