...
<span>
    ...
    <nav id="top-nav" class="navbar-expand-md navbar-light fixed-top rounded nav-bar-bg" hidden="hidden">
    ...
    <footer class="footer">
        <div class="container">
            <span class="ml-5 small text-muted">Karma, Jasmine, RollUp and Vue Acceptance Test and Build Demo</span>
