...
dodexContent = {
	cards: {
		...
		card20: {
			tab: "T",
			front: {
				content: "<h1>Test Table</h1><a href=\"#/table/tools\"><i class=\"fas fa-table\"></i>Table View</a></router-link>"
			},
			back: {
		...
		"card23": {
			tab: "W",
			front: {
				content: "<h1>Vue Welcome</h1><a href=\"#/welcome\"><i class=\"fas fa-door-open\"></i>Welcome</a>"
			},
			back: {
				content: ""
			}
