	...
	return {
		cards: {
			...
			card3: {
				tab: "C",
				back: {
					"content": "<h1>Best's Contact Form</h1><a href=\"#!contact\"><i class=\"fas fa-fw fa-phone pr-4\"></i>Contact</a>"
				},
				front: {
			...
			"card16": {
				tab: "P",
				front: {
					content: "<h1>Test Pdf</h1><a href=\"#/pdf/test\"><i class=\"fas fa-fw fa-file-pdf pr-4\"></i>PDF View</a>"
				},
				back: {
			...
			card20: {
				tab: "T",
				back: {
					content: "<h1>Test Table</h1><a href=\"#/table/tools\"><i class=\"fas fa-fw fa-table pr-4\"></i>Table View</a>"
				},
				front: {
			...
			card8: {
				tab: "H",
				front: {
					content: "<h1>Description</h1><a href=\"#!\"><i class=\"fas fa-fw fa-home pr-4\"></i>Home</a>"
				},
				back: {
